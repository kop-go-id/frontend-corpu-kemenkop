...
const CoursePretestWelcomePage = () => {
        ...
        <div className="max-w-6xl mx-auto w-full px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="md:pl-6">
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-600 max-w-md">
              Sebelum melanjutkan ke modul pembelajaran, mohon selesaikan pretest berikut.
              Tes ini bertujuan untuk mengukur pemahaman awal Anda dan tidak memiliki nilai
              minimum kelulusan
            </p>

            <Button
              onClick={() => router.push(`/user/pretest/${courseId}`)}
...
export default CoursePretestWelcomePage